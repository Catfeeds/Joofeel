        ...
        foreach ($res as $k => $v) {
            if ($k > 0) {
                GoodsModel::create([
                    ...
                    'created_at' => date('Y-m-d H:i:s',$v[30]),
                    'updated_at' => date('Y-m-d H:i:s',$v[31]),
                ]);
            }
        }
    }
        ...
        foreach ($res as $k => $v)
        {
            if($k>0)
            {
                GoodsOrder::create([
                    ...
                    'carriage'  => $v[9],
                    'receipt_name'  => $v[12],
                    'receipt_address'  => $v[13],
                    'receipt_phone'  => $v[14],
                    'isSign'  => $v[15],
                    'isDeleteUser'  => $v[16],
                    'isPay'  => $v[17],
                    'created_at' => date('Y-m-d H:i:s',$v[19]),
                    'updated_at' => date('Y-m-d H:i:s',$v[20]),
                ]);
            }
        }
    }
